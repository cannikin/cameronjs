...
const localPackages = [
  ...
  "autoprefixer",
  "https://github.com/cannikin/file-include-webpack-plugin.git#three-level-fix",
  // "file-include-webpack-plugin" once https://github.com/Vishal0203/file-include-webpack-plugin/pull/11 is merged
  "postcss-cli",
  "postcss-import",
  "postcss-nested",
...
module.exports = class {
  ...
  addDevPackages() {
    ...
    const { status } = this.addPackages("--dev", devPackages);
  ...
  addPackages(flags, packages) {
    ...
    const { status } = spawnSync(
      "yarn",
      [flags, "--cwd", this.appName, "add", ...packages],
      spawnOptions
    );
