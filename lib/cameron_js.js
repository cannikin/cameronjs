...
module.exports = class {
  ...
  addDevPackages() {
    ...
    const { status } = this.addPackageGroup(devPackages, "add", "--dev");
  ...
  addPackageGroup(packages, dev = false) {
  ...
  postInstall() {
    ...
    console.log("|     |___ _____ ___ ___ ___ ___ __|  |   __|");
    console.log("|   --| .'|     | -_|  _| . |   |  |  |__   |");
    console.log("|_____|__,|_|_|_|___|_| |___|_|_|_____|_____|");
