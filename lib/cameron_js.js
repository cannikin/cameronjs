...
module.exports = class {
  ...
  addLocalPackages() {
    ...
    const { status } = this.addPackageGroup(localPackages);
  ...
  addDevPackages() {
    ...
    const { status } = this.addPackageGroup(devPackages, "--dev");
  ...
  addGlobalPackages() {
    ...
    const { stderr, status } = this.addPackageGroup(globalPackages, "-g");
  ...
  addPackageGroup(packages, flags = "") {
    let args = ["add", "--cmd", this.appName];
    if (flags) {
      args.push(flags);
    }
